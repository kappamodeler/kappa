...
let ccomp_type = "cc"
let bytecomp_c_compiler = "gcc -arch x86_64 -fno-defer-pop -no-cpp-precomp -Wall -D_FILE_OFFSET_BITS=64 -D_REENTRANT "
let bytecomp_c_linker = "gcc -arch x86_64 "
let bytecomp_c_libraries = "-lm  -lcurses -lpthread"
let native_c_compiler = "gcc -arch x86_64 -D_FILE_OFFSET_BITS=64 -D_REENTRANT"
let native_c_linker = "gcc -arch x86_64 "
let native_c_libraries = "-lm "
let native_partial_linker = "ld -r -arch x86_64 "
