...
type 'a pipeline = {
    ...
    template: file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> file_name -> 'a step ;
...
,(l,m))
	 ...
	 (fun file0 file1 file2 file3 file4 file5 file6 file7 file8 file9 file10 prefix pb (l,m) ->
	   ...
	   | Some rep' -> 
	       ...
	       then (
		     let pb,log = reachability_analysis prefix' rep  (l,m) in
	             template file0 file1 file2 file3 file4 file5 file6 file7 file8 file9 file10 prefix pb (l,m))
	       else (
		 match pb with 
		   None -> pb,(l,m) 
		 | Some a -> 
	 ...
	 with 
	   Exception _ -> None,c);
       template = (fun a b c d e f g h i j k -> handle_errors_step (Some "Complx") (Some "template") (template a b c d e f g h i j k));
