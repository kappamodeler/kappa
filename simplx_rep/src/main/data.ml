...
let version_main = 3
let version_cpt = 7 (*Simplx problem in perturbation not applied when system was deadlocking first and conflict in --quotient-refinements option and Bologna resolved.*)
